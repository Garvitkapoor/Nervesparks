...
# Note: this may take several minutes and download large wheels & model files.
!pip install -q streamlit pyngrok chromadb sentence-transformers transformers pypdf scikit-learn tiktoken joblib

# Check torch (Colab usually has a compatible torch)
...
# configure (one-time)
!git config --global user.email "kapoorgarvit499@gmail.com"
!git config --global user.name "Garvitkapoor"

# init and push (replace with your repo URL)
!git init
!git add -A
!git commit -m "Initial commit: Streamlit RAG app"
!git branch -M main
!git remote add origin https://github.com/<your-username>/<your-repo>.git
# If this fails due to auth, use a PAT or push from your workstation
